...
const SHIPPING_SECTIONS: ShippingSection[] = [
  {
    ...
    body: [
      ...
      "*Изпращаме поръчки от понеделник до четвъртък. Не изпращаме в петък, за да пристигнат продуктите максимално свежи. Поръчки, направени след 16:30 ч. в четвъртък, се изпращат в следващия понеделник.",
    ],
  },
  {
