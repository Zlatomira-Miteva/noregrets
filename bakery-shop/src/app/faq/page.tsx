...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      "За да завършите процеса по връщане, молим да предоставите номер на поръчка или доказателство за покупка. За начало на процедурата ни пишете на zlati.noregrets@gmail.com.",
    ],
  },
  {
        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 px-[clamp(1.25rem,4vw,4rem)] py-20">
          ...
          <header className="space-y-3 text-center">
            ...
            <p className="/80">
              ...
              <a href="mailto:zlati.noregrets@gmail.com" className="underline">
                {" "}
                zlati.noregrets@gmail.com{" "}
              </a>{" "}
              .{" "}
            </p>{" "}
          </header>{" "}
