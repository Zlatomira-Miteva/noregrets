            ...
            <div className="space-y-10">
              ...
              <div className="space-y-6 rounded-2xl bg-white/80 p-6 text-sm ">
                <div className="space-y-3">
                  ...
                  <p>
                    Печем всичко в деня на изпращане и пакетираме бисквитките за максимална свежест. Кукитата остават най-вкусни до две
                    седмици, ако се съхраняват на стайна температура.
                  </p>
                  <p>
                    Ако предпочитате да ги запазите за по-късно, поставете ги във фризер до един месец и ги затоплете за няколко минути преди
                    сервиране.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <p>
                    Всички бисквитки съдържат глутен. Някои бисквитки съдържат ядки. Ако имате алергии, моля, прочетете внимателно
