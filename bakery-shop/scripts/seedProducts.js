...
const tiramisu = [
  {
    ...
    description: "Маскарпоне, еспресо и какао върху напоени бишкоти – класическа рецепта с No Regrets почерк.",
    shortDescription: "Маскарпоне крем, еспресо сироп, бишкоти Savoiardi, какао",
    price: 6.9,
    weight: "180 гр.",
    leadTime: "Доставка до 4 работни дни",
  ...
  },
  {
    ...
    shortDescription: "Маскарпоне крем, ягодово сладко, бишкоти Savoiardi, какао",
    price: 7.2,
    weight: "180 гр.",
    leadTime: "Доставка до 4 работни дни",
  ...
  },
  {
    ...
    shortDescription: "Маскарпоне крем, шамфъстък паста, еспресо сироп, бишкоти Savoiardi",
    price: 7.6,
    weight: "180 гр.",
    leadTime: "Доставка до 4 работни дни",
    heroImage: "/regular-tiramisu.png",
